...
# Resnet18 pretrained on BigEarthNet v2.0 using Sentinel-2 bands
...
| Metric            |       Macro |       Micro |
|:------------------|------------------:|------------------:|
| Average Precision |        0.701223 |        0.860081 |
| F1 Score          |        0.644276 |        0.762562 |
| Precision         | 0.695591 | 0.793524 |
...
model = BigEarthNetv2_0_ImageClassifier.from_pretrained(
  "BIFOLD-BigEarthNetv2-0/resnet18-s2-v0.2.0")
```
